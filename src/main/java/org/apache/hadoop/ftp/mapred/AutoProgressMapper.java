 ...
 */
public class AutoProgressMapper<KEYIN, VALIN, KEYOUT, VALOUT> extends FTP2HDFSMapper<KEYIN, VALIN, KEYOUT, VALOUT> {

	public static final Log LOG = LogFactory.getLog(AutoProgressMapper.class.getName());

	public static final String MAX_PROGRESS_PERIOD_KEY = "ftp2hdfs.mapred.auto.progress.max";
	public static final String SLEEP_INTERVAL_KEY = "ftp2hdfs.mapred.auto.progress.sleep";
	public static final String REPORT_INTERVAL_KEY = "ftp2hdfs.mapred.auto.progress.report";
	...
	/**
	 * Run the mapping process for this task, wrapped in an auto-progress
	 * system.
	 */
	@Override
	public void run(Context context) throws IOException, InterruptedException {
		...
		try {
			...
			try {
				...
				LOG.warn("Interrupted when waiting on auto-progress thread: " + ie.toString(), ie);
			}
		}
	}
}
